      ...
      >
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <div className="mb-8">
              <h2
                className="text-2xl font-bold mb-6 font-display text-[#00274C] dark:text-white"
              >
                Personal Information
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label
                    className="block text-sm font-semibold mb-2 font-sans text-[#00274C] dark:text-white"
                  >
                    First Name *
                  </label>
                  <input
            ...
            <div className="mb-8">
              ...
              <label
                className="block text-sm font-semibold mb-4 font-sans text-[#00274C] dark:text-white"
              >
            ...
            <div className="text-center">
              ...
              {errors.general && (
                <div className="mb-6 p-4 bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded-lg">
                  <p className="text-red-700 dark:text-red-200 font-sans">{errors.general}</p>
                </div>
              )}
